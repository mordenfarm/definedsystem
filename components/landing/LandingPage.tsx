...
const TeamCarousel = () => {
  ...
  const team = [
    { name: "Doctor Dhliwayo", role: "Counselor and Consultant", image: "https://i.ibb.co/Z6S7gMwY/mdaradomain.jpg" },
    ...
    { name: "Ropafadzo Chikuni", role: "Assistant operation manager", image: "https://i.ibb.co/0RpXhpN6/ropafadzo.jpg" },
  ];
  ...
  const handlePrev = () => {
    ...
    if (scrollRef.current) {
      const cardWidth = 320;
      const gap = 32;
      const scrollAmount = prevIndex * (cardWidth + gap);
      scrollRef.current.scrollTo({
        left: scrollAmount,
        behavior: 'smooth'
      });
  ...
  return (
    <div className="relative py-32 bg-white dark:bg-slate-950 overflow-hidden border-t border-slate-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-6 mb-20 text-center space-y-4 flex items-center justify-between">
         ...
         <div className="flex gap-4">
            <button
              onClick={handlePrev}
              className="p-3 rounded-full border border-slate-200 dark:border-slate-800 hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all duration-300"
      ...
      >
        {team.map((member, idx) => (
          <div 
            ...
            `}
          >
            <div className="relative w-full h-full overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] border border-slate-200 dark:border-slate-800 bg-slate-100 rounded-[9px]">
               <img 
                 src={member.image} 
              ...
              <div className="max-w-7xl mx-auto px-0 md:px-6">
                 <div className="relative rounded-none overflow-hidden shadow-[0_100px_150px_-40px_rgba(0,0,0,0.7)] border-y md:border border-slate-200 dark:border-slate-800 group min-h-[450px] md:min-h-[750px] bg-slate-100 dark:bg-slate-900 flex flex-col">
                    ...
                    <div className="flex-1 grid grid-cols-3 md:grid-cols-5 gap-2 p-2">
                      {[
                        "https://i.ibb.co/Z6S7gMwY/mdaradomain.jpg",
                        ...
                        "https://i.ibb.co/0RpXhpN6/ropafadzo.jpg",
